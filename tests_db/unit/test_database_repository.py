...
def test_repository_returns_an_empty_list_for_non_existent_search(session_factory):
    pass

def test_repository_can_get_list_of_games(session_factory):
    pass
...
def test_repository_does_not_get_a_non_existent_genre(session_factory):
    pass
